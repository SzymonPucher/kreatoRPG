$(function(){
	var bohater = {
		...
		zrecznosc:0, percepcja:0, charakter:0, spryt:0, budowa:0,
...
// ----------------------------------- WSPÓŁCZYNNIKI RZUCONE --------------------------------
	...
	function wsp_rzuc(){
		bohater.zrecznosc = $("#userInput_zr").val();
		bohater.percepcja = $("#userInput_pc").val();
		bohater.charakter = $("#userInput_ch").val();
		bohater.spryt = $("#userInput_sp").val();
		bohater.budowa = $("#userInput_bd").val();
	}

// ----------------------------------- WSPÓŁCZYNNIKI WYBRANE -------------------------------------
	
	$("#plus_zr").click(function(){ if (bohater.zrecznosc < 19 && spl > 0){ $("#dice_distribution_points_zr").html(++bohater.zrecznosc); $("#dice_distribution_points_left").html(--spl); } });
	
	$("#plus_pc").click(function(){ if (bohater.percepcja < 19 && spl > 0){ $("#dice_distribution_points_pc").html(++bohater.percepcja); $("#dice_distribution_points_left").html(--spl); } });
	
	$("#plus_ch").click(function(){ if (bohater.charakter < 19 && spl > 0){ $("#dice_distribution_points_ch").html(++bohater.charakter); $("#dice_distribution_points_left").html(--spl); } });
	
	$("#plus_sp").click(function(){ if (bohater.spryt < 19 && spl > 0){ $("#dice_distribution_points_sp").html(++bohater.spryt); $("#dice_distribution_points_left").html(--spl); } });
	
	$("#plus_bd").click(function(){ if (bohater.budowa < 19 && spl > 0){ $("#dice_distribution_points_bd").html(++bohater.budowa); $("#dice_distribution_points_left").html(--spl); } });
	
	$("#minus_zr").click(function(){ if (bohater.zrecznosc > 4){ $("#dice_distribution_points_zr").html(--bohater.zrecznosc); $("#dice_distribution_points_left").html(++spl); } });
	
	$("#minus_pc").click(function(){ if (bohater.percepcja > 4){ $("#dice_distribution_points_pc").html(--bohater.percepcja); $("#dice_distribution_points_left").html(++spl); } });
	
	$("#minus_ch").click(function(){ if (bohater.charakter > 4){ $("#dice_distribution_points_ch").html(--bohater.charakter); $("#dice_distribution_points_left").html(++spl); }; });
	
	$("#minus_sp").click(function(){ if (bohater.spryt > 4){ $("#dice_distribution_points_sp").html(--bohater.spryt); $("#dice_distribution_points_left").html(++spl); } });
	...
	$("#r_zr_1").click(function(){ r_reset_1(); r_reset_zr(); $("#r_zr_1").show(); $("#r_zr_1").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.zrecznosc = r_num[0]; $("#r_final_zr").html(bohater.zrecznosc); });
	$("#r_zr_2").click(function(){ r_reset_2(); r_reset_zr(); $("#r_zr_2").show(); $("#r_zr_2").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.zrecznosc = r_num[1]; $("#r_final_zr").html(bohater.zrecznosc); });
	$("#r_zr_3").click(function(){ r_reset_3(); r_reset_zr(); $("#r_zr_3").show(); $("#r_zr_3").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.zrecznosc = r_num[2]; $("#r_final_zr").html(bohater.zrecznosc); });
	$("#r_zr_4").click(function(){ r_reset_4(); r_reset_zr(); $("#r_zr_4").show(); $("#r_zr_4").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.zrecznosc = r_num[3]; $("#r_final_zr").html(bohater.zrecznosc); });
	$("#r_zr_5").click(function(){ r_reset_5(); r_reset_zr(); $("#r_zr_5").show(); $("#r_zr_5").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.zrecznosc = r_num[4]; $("#r_final_zr").html(bohater.zrecznosc); });
	
	$("#r_pc_1").click(function(){ r_reset_1(); r_reset_pc(); $("#r_pc_1").show(); $("#r_pc_1").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.percepcja = r_num[0]; $("#r_final_pc").html(bohater.percepcja); });
	$("#r_pc_2").click(function(){ r_reset_2(); r_reset_pc(); $("#r_pc_2").show(); $("#r_pc_2").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.percepcja = r_num[1]; $("#r_final_pc").html(bohater.percepcja); });
	$("#r_pc_3").click(function(){ r_reset_3(); r_reset_pc(); $("#r_pc_3").show(); $("#r_pc_3").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.percepcja = r_num[2]; $("#r_final_pc").html(bohater.percepcja); });
	$("#r_pc_4").click(function(){ r_reset_4(); r_reset_pc(); $("#r_pc_4").show(); $("#r_pc_4").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.percepcja = r_num[3]; $("#r_final_pc").html(bohater.percepcja); });
	$("#r_pc_5").click(function(){ r_reset_5(); r_reset_pc(); $("#r_pc_5").show(); $("#r_pc_5").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.percepcja = r_num[4]; $("#r_final_pc").html(bohater.percepcja); });
	
	$("#r_ch_1").click(function(){ r_reset_1(); r_reset_ch(); $("#r_ch_1").show(); $("#r_ch_1").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.charakter = r_num[0]; $("#r_final_ch").html(bohater.charakter); });
	$("#r_ch_2").click(function(){ r_reset_2(); r_reset_ch(); $("#r_ch_2").show(); $("#r_ch_2").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.charakter = r_num[1]; $("#r_final_ch").html(bohater.charakter); });
	$("#r_ch_3").click(function(){ r_reset_3(); r_reset_ch(); $("#r_ch_3").show(); $("#r_ch_3").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.charakter = r_num[2]; $("#r_final_ch").html(bohater.charakter); });
	$("#r_ch_4").click(function(){ r_reset_4(); r_reset_ch(); $("#r_ch_4").show(); $("#r_ch_4").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.charakter = r_num[3]; $("#r_final_ch").html(bohater.charakter); });
	$("#r_ch_5").click(function(){ r_reset_5(); r_reset_ch(); $("#r_ch_5").show(); $("#r_ch_5").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.charakter = r_num[4]; $("#r_final_ch").html(bohater.charakter); });
	
	$("#r_sp_1").click(function(){ r_reset_1(); r_reset_sp(); $("#r_sp_1").show(); $("#r_sp_1").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.spryt = r_num[0]; $("#r_final_sp").html(bohater.spryt); });
	$("#r_sp_2").click(function(){ r_reset_2(); r_reset_sp(); $("#r_sp_2").show(); $("#r_sp_2").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.spryt = r_num[1]; $("#r_final_sp").html(bohater.spryt); });
	$("#r_sp_3").click(function(){ r_reset_3(); r_reset_sp(); $("#r_sp_3").show(); $("#r_sp_3").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.spryt = r_num[2]; $("#r_final_sp").html(bohater.spryt); });
	$("#r_sp_4").click(function(){ r_reset_4(); r_reset_sp(); $("#r_sp_4").show(); $("#r_sp_4").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.spryt = r_num[3]; $("#r_final_sp").html(bohater.spryt); });
	$("#r_sp_5").click(function(){ r_reset_5(); r_reset_sp(); $("#r_sp_5").show(); $("#r_sp_5").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.spryt = r_num[4]; $("#r_final_sp").html(bohater.spryt); });
	
	$("#r_bd_1").click(function(){ r_reset_1(); r_reset_bd(); $("#r_bd_1").show(); $("#r_bd_1").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.budowa = r_num[0]; $("#r_final_bd").html(bohater.budowa); });
	$("#r_bd_2").click(function(){ r_reset_2(); r_reset_bd(); $("#r_bd_2").show(); $("#r_bd_2").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.budowa = r_num[1]; $("#r_final_bd").html(bohater.budowa); });
	$("#r_bd_3").click(function(){ r_reset_3(); r_reset_bd(); $("#r_bd_3").show(); $("#r_bd_3").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.budowa = r_num[2]; $("#r_final_bd").html(bohater.budowa); });
	$("#r_bd_4").click(function(){ r_reset_4(); r_reset_bd(); $("#r_bd_4").show(); $("#r_bd_4").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.budowa = r_num[3]; $("#r_final_bd").html(bohater.budowa); });
	$("#r_bd_5").click(function(){ r_reset_5(); r_reset_bd(); $("#r_bd_5").show(); $("#r_bd_5").css({'background-image': 'url("style/img/tile1clicked.png")', 'color': 'white'}); bohater.budowa = r_num[4]; $("#r_final_bd").html(bohater.budowa); });
	...
	$("#r_reset_but").click(function(){ 
		...
		$("#r_cont_1").show();
		$(".r_final_value").html("??");
		bohater.zrecznosc = 0; bohater.percepcja = 0; bohater.charakter = 0; bohater.spryt = 0; bohater.budowa = 0;
	});
...
// UMIEJĘTNOŚCI ---------------------------------------------------------------------------------------------------------------------
	...
	function points_left_substract(x) {
	...
	// This function starts when you are trying to substract a point
	function substract_point(x1,x2,x3,x4,x5){
		y_temp = 0;
		points_left_substract(x1); // determining tha amount of points needed from spec and all points combined
		...
		if (bohater.specjalizacja == x4 || bohater.specjalizacja == x5) { // this part activates when skill is from spec
			temp = y + y_spec + y_temp; // temp = amount of points - points needed to substract point
			...
			y_spec += y_temp; // substracting points from spec pool
			if (y_spec < 0) { y += y_spec; y_spec = 0; } // if spec pool < 0 then substract points from global pool
		}
	...
	$("#minus_ww1").click(function(){ $("#karta_ww1, #skill_value_ww1").html(ww[0] = substract_point(ww[0],ww[1],ww[2],ww[3],ww[4])); });
	$("#plus_ww2").click(function(){ $("#karta_ww2, #skill_value_ww2").html(ww[1] = add_point(ww[1],ww[0],ww[2],ww[3],ww[4])); });
	$("#minus_ww2").click(function(){ $("#karta_ww2, #skill_value_ww2").html(ww[1] = substract_point(ww[1],ww[0],ww[2],ww[3],ww[4])); });
	$("#plus_ww3").click(function(){ $("#karta_ww3, #skill_value_ww3").html(ww[2] = add_point(ww[2],ww[0],ww[1],ww[3],ww[4])); });
	$("#minus_ww3").click(function(){ $("#karta_ww3, #skill_value_ww3").html(ww[2] = substract_point(ww[2],ww[0],ww[1],ww[3],ww[4])); });
	// ------------------ BROŃ STRZELECKA ----------------------
	$("#plus_bs1").click(function(){ $("#karta_bs1, #skill_value_bs1").html(bs[0] = add_point(bs[0],bs[1],bs[2],bs[3],bs[4])); });
	$("#minus_bs1").click(function(){ $("#karta_bs1, #skill_value_bs1").html(bs[0] = substract_point(bs[0],bs[1],bs[2],bs[3],bs[4])); });
	$("#plus_bs2").click(function(){ $("#karta_bs2, #skill_value_bs2").html(bs[1] = add_point(bs[1],bs[0],bs[2],bs[3],bs[4])); });
	$("#minus_bs2").click(function(){ $("#karta_bs2, #skill_value_bs2").html(bs[1] = substract_point(bs[1],bs[0],bs[2],bs[3],bs[4])); });
	$("#plus_bs3").click(function(){ $("#karta_bs3, #skill_value_bs3").html(bs[2] = add_point(bs[2],bs[0],bs[1],bs[3],bs[4])); });
	$("#minus_bs3").click(function(){ $("#karta_bs3, #skill_value_bs3").html(bs[2] = substract_point(bs[2],bs[0],bs[1],bs[3],bs[4])); });
	// ------------------ BROŃ DYSTANSOWA ----------------------
	$("#plus_bd1").click(function(){ $("#karta_bd1, #skill_value_bd1").html(bd[0] = add_point(bd[0],bd[1],bd[2],bd[3],bd[4])); });
	$("#minus_bd1").click(function(){ $("#karta_bd1, #skill_value_bd1").html(bd[0] = substract_point(bd[0],bd[1],bd[2],bd[3],bd[4])); });
	$("#plus_bd2").click(function(){ $("#karta_bd2, #skill_value_bd2").html(bd[1] = add_point(bd[1],bd[0],bd[2],bd[3],bd[4])); });
	$("#minus_bd2").click(function(){ $("#karta_bd2, #skill_value_bd2").html(bd[1] = substract_point(bd[1],bd[0],bd[2],bd[3],bd[4])); });
	$("#plus_bd3").click(function(){ $("#karta_bd3, #skill_value_bd3").html(bd[2] = add_point(bd[2],bd[0],bd[1],bd[3],bd[4])); });
	$("#minus_bd3").click(function(){ $("#karta_bd3, #skill_value_bd3").html(bd[2] = substract_point(bd[2],bd[0],bd[1],bd[3],bd[4])); });
	// ------------------ PROWADZENIE POJAZDÓW ----------------------
	$("#plus_pp1").click(function(){ $("#karta_pp1, #skill_value_pp1").html(pp[0] = add_point(pp[0],pp[1],pp[2],pp[3],pp[4])); });
	$("#minus_pp1").click(function(){ $("#karta_pp1, #skill_value_pp1").html(pp[0] = substract_point(pp[0],pp[1],pp[2],pp[3],pp[4])); });
	$("#plus_pp2").click(function(){ $("#karta_pp2, #skill_value_pp2").html(pp[1] = add_point(pp[1],pp[0],pp[2],pp[3],pp[4])); });
	$("#minus_pp2").click(function(){ $("#karta_pp2, #skill_value_pp2").html(pp[1] = substract_point(pp[1],pp[0],pp[2],pp[3],pp[4])); });
	$("#plus_pp3").click(function(){ $("#karta_pp3, #skill_value_pp3").html(pp[2] = add_point(pp[2],pp[0],pp[1],pp[3],pp[4])); });
	$("#minus_pp3").click(function(){ $("#karta_pp3, #skill_value_pp3").html(pp[2] = substract_point(pp[2],pp[0],pp[1],pp[3],pp[4])); });
	// ------------------ ZDOLNOŚCI MANUALNE ----------------------
	$("#plus_zm1").click(function(){ $("#karta_zm1, #skill_value_zm1").html(zm[0] = add_point(zm[0],zm[1],zm[2],zm[3],zm[4])); });
	$("#minus_zm1").click(function(){ $("#karta_zm1, #skill_value_zm1").html(zm[0] = substract_point(zm[0],zm[1],zm[2],zm[3],zm[4])); });
	$("#plus_zm2").click(function(){ $("#karta_zm2, #skill_value_zm2").html(zm[1] = add_point(zm[1],zm[0],zm[2],zm[3],zm[4])); });
	$("#minus_zm2").click(function(){ $("#karta_zm2, #skill_value_zm2").html(zm[1] = substract_point(zm[1],zm[0],zm[2],zm[3],zm[4])); });
	$("#plus_zm3").click(function(){ $("#karta_zm3, #skill_value_zm3").html(zm[2] = add_point(zm[2],zm[0],zm[1],zm[3],zm[4])); });
	$("#minus_zm3").click(function(){ $("#karta_zm3, #skill_value_zm3").html(zm[2] = substract_point(zm[2],zm[0],zm[1],zm[3],zm[4])); });
	// ------------------ ORINTACJA W TERENIE ----------------------
	$("#plus_ot1").click(function(){ $("#karta_ot1, #skill_value_ot1").html(ot[0] = add_point(ot[0],ot[1],ot[2],ot[3],ot[4])); });
	$("#minus_ot1").click(function(){ $("#karta_ot1, #skill_value_ot1").html(ot[0] = substract_point(ot[0],ot[1],ot[2],ot[3],ot[4])); });
	$("#plus_ot2").click(function(){ $("#karta_ot2, #skill_value_ot2").html(ot[1] = add_point(ot[1],ot[0],ot[2],ot[3],ot[4])); });
	$("#minus_ot2").click(function(){ $("#karta_ot2, #skill_value_ot2").html(ot[1] = substract_point(ot[1],ot[0],ot[2],ot[3],ot[4])); });
	$("#plus_ot3").click(function(){ $("#karta_ot3, #skill_value_ot3").html(ot[2] = add_point(ot[2],ot[0],ot[1],ot[3],ot[4])); });
	$("#minus_ot3").click(function(){ $("#karta_ot3, #skill_value_ot3").html(ot[2] = substract_point(ot[2],ot[0],ot[1],ot[3],ot[4])); });
	// ------------------ SPOSTRZEGAWCZOŚĆ ----------------------
	$("#plus_sg1").click(function(){ $("#karta_sg1, #skill_value_sg1").html(sg[0] = add_point(sg[0],sg[1],sg[2],sg[3],sg[4])); });
	$("#minus_sg1").click(function(){ $("#karta_sg1, #skill_value_sg1").html(sg[0] = substract_point(sg[0],sg[1],sg[2],sg[3],sg[4])); });
	$("#plus_sg2").click(function(){ $("#karta_sg2, #skill_value_sg2").html(sg[1] = add_point(sg[1],sg[0],sg[2],sg[3],sg[4])); });
	$("#minus_sg2").click(function(){ $("#karta_sg2, #skill_value_sg2").html(sg[1] = substract_point(sg[1],sg[0],sg[2],sg[3],sg[4])); });
	$("#plus_sg3").click(function(){ $("#karta_sg3, #skill_value_sg3").html(sg[2] = add_point(sg[2],sg[0],sg[1],sg[3],sg[4])); });
	$("#minus_sg3").click(function(){ $("#karta_sg3, #skill_value_sg3").html(sg[2] = substract_point(sg[2],sg[0],sg[1],sg[3],sg[4])); });
	// ------------------ KAMUFLAŻ ----------------------
	$("#plus_ka1").click(function(){ $("#karta_ka1, #skill_value_ka1").html(ka[0] = add_point(ka[0],ka[1],ka[2],ka[3],ka[4])); });
	$("#minus_ka1").click(function(){ $("#karta_ka1, #skill_value_ka1").html(ka[0] = substract_point(ka[0],ka[1],ka[2],ka[3],ka[4])); });
	$("#plus_ka2").click(function(){ $("#karta_ka2, #skill_value_ka2").html(ka[1] = add_point(ka[1],ka[0],ka[2],ka[3],ka[4])); });
	$("#minus_ka2").click(function(){ $("#karta_ka2, #skill_value_ka2").html(ka[1] = substract_point(ka[1],ka[0],ka[2],ka[3],ka[4])); });
	$("#plus_ka3").click(function(){ $("#karta_ka3, #skill_value_ka3").html(ka[2] = add_point(ka[2],ka[0],ka[1],ka[3],ka[4])); });
	$("#minus_ka3").click(function(){ $("#karta_ka3, #skill_value_ka3").html(ka[2] = substract_point(ka[2],ka[0],ka[1],ka[3],ka[4])); });
	// ------------------ PRZETRWANIE ----------------------
	$("#plus_pr1").click(function(){ $("#karta_pr1, #skill_value_pr1").html(pr[0] = add_point(pr[0],pr[1],pr[2],pr[3],pr[4])); });
	$("#minus_pr1").click(function(){ $("#karta_pr1, #skill_value_pr1").html(pr[0] = substract_point(pr[0],pr[1],pr[2],pr[3],pr[4])); });
	$("#plus_pr2").click(function(){ $("#karta_pr2, #skill_value_pr2").html(pr[1] = add_point(pr[1],pr[0],pr[2],pr[3],pr[4])); });
	$("#minus_pr2").click(function(){ $("#karta_pr2, #skill_value_pr2").html(pr[1] = substract_point(pr[1],pr[0],pr[2],pr[3],pr[4])); });
	$("#plus_pr3").click(function(){ $("#karta_pr3, #skill_value_pr3").html(pr[2] = add_point(pr[2],pr[0],pr[1],pr[3],pr[4])); });
	$("#minus_pr3").click(function(){ $("#karta_pr3, #skill_value_pr3").html(pr[2] = substract_point(pr[2],pr[0],pr[1],pr[3],pr[4])); });
	// ------------------ NEGOCJACJE ----------------------
	$("#plus_ng1").click(function(){ $("#karta_ng1, #skill_value_ng1").html(ng[0] = add_point(ng[0],ng[1],ng[2],ng[3],ng[4])); });
	$("#minus_ng1").click(function(){ $("#karta_ng1, #skill_value_ng1").html(ng[0] = substract_point(ng[0],ng[1],ng[2],ng[3],ng[4])); });
	$("#plus_ng2").click(function(){ $("#karta_ng2, #skill_value_ng2").html(ng[1] = add_point(ng[1],ng[0],ng[2],ng[3],ng[4])); });
	$("#minus_ng2").click(function(){ $("#karta_ng2, #skill_value_ng2").html(ng[1] = substract_point(ng[1],ng[0],ng[2],ng[3],ng[4])); });
	$("#plus_ng3").click(function(){ $("#karta_ng3, #skill_value_ng3").html(ng[2] = add_point(ng[2],ng[0],ng[1],ng[3],ng[4])); });
	$("#minus_ng3").click(function(){ $("#karta_ng3, #skill_value_ng3").html(ng[2] = substract_point(ng[2],ng[0],ng[1],ng[3],ng[4])); });
	// ------------------ EMPATIA ----------------------
	$("#plus_em1").click(function(){ $("#karta_em1, #skill_value_em1").html(em[0] = add_point(em[0],em[1],em[2],em[3],em[4])); });
	$("#minus_em1").click(function(){ $("#karta_em1, #skill_value_em1").html(em[0] = substract_point(em[0],em[1],em[2],em[3],em[4])); });
	$("#plus_em2").click(function(){ $("#karta_em2, #skill_value_em2").html(em[1] = add_point(em[1],em[0],em[2],em[3],em[4])); });
	$("#minus_em2").click(function(){ $("#karta_em2, #skill_value_em2").html(em[1] = substract_point(em[1],em[0],em[2],em[3],em[4])); });
	$("#plus_em3").click(function(){ $("#karta_em3, #skill_value_em3").html(em[2] = add_point(em[2],em[0],em[1],em[3],em[4])); });
	$("#minus_em3").click(function(){ $("#karta_em3, #skill_value_em3").html(em[2] = substract_point(em[2],em[0],em[1],em[3],em[4])); });
	// ------------------ SIŁA WOLI ----------------------
	$("#plus_sw1").click(function(){ $("#karta_sw1, #skill_value_sw1").html(sw[0] = add_point(sw[0],sw[1],sw[2],sw[3],sw[4])); });
	$("#minus_sw1").click(function(){ $("#karta_sw1, #skill_value_sw1").html(sw[0] = substract_point(sw[0],sw[1],sw[2],sw[3],sw[4])); });
	$("#plus_sw2").click(function(){ $("#karta_sw2, #skill_value_sw2").html(sw[1] = add_point(sw[1],sw[0],sw[2],sw[3],sw[4])); });
	$("#minus_sw2").click(function(){ $("#karta_sw2, #skill_value_sw2").html(sw[1] = substract_point(sw[1],sw[0],sw[2],sw[3],sw[4])); });
	$("#plus_sw3").click(function(){ $("#karta_sw3, #skill_value_sw3").html(sw[2] = add_point(sw[2],sw[0],sw[1],sw[3],sw[4])); });
	$("#minus_sw3").click(function(){ $("#karta_sw3, #skill_value_sw3").html(sw[2] = substract_point(sw[2],sw[0],sw[1],sw[3],sw[4])); });
	// ------------------ MEDYCYNA ----------------------
	$("#plus_me1").click(function(){ $("#karta_me1, #skill_value_me1").html(me[0] = add_point(me[0],me[1],me[2],me[3],me[4])); });
	$("#minus_me1").click(function(){ $("#karta_me1, #skill_value_me1").html(me[0] = substract_point(me[0],me[1],me[2],me[3],me[4])); });
	$("#plus_me2").click(function(){ $("#karta_me2, #skill_value_me2").html(me[1] = add_point(me[1],me[0],me[2],me[3],me[4])); });
	$("#minus_me2").click(function(){ $("#karta_me2, #skill_value_me2").html(me[1] = substract_point(me[1],me[0],me[2],me[3],me[4])); });
	$("#plus_me3").click(function(){ $("#karta_me3, #skill_value_me3").html(me[2] = add_point(me[2],me[0],me[1],me[3],me[4])); });
	$("#minus_me3").click(function(){ $("#karta_me3, #skill_value_me3").html(me[2] = substract_point(me[2],me[0],me[1],me[3],me[4])); });
	// ------------------ TECHNIKA ----------------------
	$("#plus_te1").click(function(){ $("#karta_te1, #skill_value_te1").html(te[0] = add_point(te[0],te[1],te[2],te[3],te[4])); });
	$("#minus_te1").click(function(){ $("#karta_te1, #skill_value_te1").html(te[0] = substract_point(te[0],te[1],te[2],te[3],te[4])); });
	$("#plus_te2").click(function(){ $("#karta_te2, #skill_value_te2").html(te[1] = add_point(te[1],te[0],te[2],te[3],te[4])); });
	$("#minus_te2").click(function(){ $("#karta_te2, #skill_value_te2").html(te[1] = substract_point(te[1],te[0],te[2],te[3],te[4])); });
	$("#plus_te3").click(function(){ $("#karta_te3, #skill_value_te3").html(te[2] = add_point(te[2],te[0],te[1],te[3],te[4])); });
	$("#minus_te3").click(function(){ $("#karta_te3, #skill_value_te3").html(te[2] = substract_point(te[2],te[0],te[1],te[3],te[4])); });
	// ------------------ WIEDZA OGÓLNA ----------------------
	...
	$("#minus_sp1").click(function(){ $("#karta_sp1, #skill_value_sp1").html(sp[0] = substract_point(sp[0],sp[1],sp[2],sp[3],sp[4])); });
	$("#plus_sp2").click(function(){ $("#karta_sp2, #skill_value_sp2").html(sp[1] = add_point(sp[1],sp[0],sp[2],sp[3],sp[4])); });
	$("#minus_sp2").click(function(){ $("#karta_sp2, #skill_value_sp2").html(sp[1] = substract_point(sp[1],sp[0],sp[2],sp[3],sp[4])); });
	$("#plus_sp3").click(function(){ $("#karta_sp3, #skill_value_sp3").html(sp[2] = add_point(sp[2],sp[0],sp[1],sp[3],sp[4])); });
	$("#minus_sp3").click(function(){ $("#karta_sp3, #skill_value_sp3").html(sp[2] = substract_point(sp[2],sp[0],sp[1],sp[3],sp[4])); });
	// ------------------ PIROTECHNIKA ----------------------
	$("#plus_pt1").click(function(){ $("#karta_pt1, #skill_value_pt1").html(pt[0] = add_point(pt[0],pt[1],pt[2],pt[3],pt[4])); });
	$("#minus_pt1").click(function(){ $("#karta_pt1, #skill_value_pt1").html(pt[0] = substract_point(pt[0],pt[1],pt[2],pt[3],pt[4])); });
	$("#plus_pt2").click(function(){ $("#karta_pt2, #skill_value_pt2").html(pt[1] = add_point(pt[1],pt[0],pt[2],pt[3],pt[4])); });
	$("#minus_pt2").click(function(){ $("#karta_pt2, #skill_value_pt2").html(pt[1] = substract_point(pt[1],pt[0],pt[2],pt[3],pt[4])); });
	$("#plus_pt3").click(function(){ $("#karta_pt3, #skill_value_pt3").html(pt[2] = add_point(pt[2],pt[0],pt[1],pt[3],pt[4])); });
	$("#minus_pt3").click(function(){ $("#karta_pt3, #skill_value_pt3").html(pt[2] = substract_point(pt[2],pt[0],pt[1],pt[3],pt[4])); });
	// ------------------ SPRAWNOŚĆ ----------------------
	$("#plus_sn1").click(function(){ $("#karta_sn1, #skill_value_sn1").html(sn[0] = add_point(sn[0],sn[1],sn[2],sn[3],sn[4])); });
	$("#minus_sn1").click(function(){ $("#karta_sn1, #skill_value_sn1").html(sn[0] = substract_point(sn[0],sn[1],sn[2],sn[3],sn[4])); });
	$("#plus_sn2").click(function(){ $("#karta_sn2, #skill_value_sn2").html(sn[1] = add_point(sn[1],sn[0],sn[2],sn[3],sn[4])); });
	$("#minus_sn2").click(function(){ $("#karta_sn2, #skill_value_sn2").html(sn[1] = substract_point(sn[1],sn[0],sn[2],sn[3],sn[4])); });
	$("#plus_sn3").click(function(){ $("#karta_sn3, #skill_value_sn3").html(sn[2] = add_point(sn[2],sn[0],sn[1],sn[3],sn[4])); });
	$("#minus_sn3").click(function(){ $("#karta_sn3, #skill_value_sn3").html(sn[2] = substract_point(sn[2],sn[0],sn[1],sn[3],sn[4])); });
	// ------------------ JEŹDZIECTWO ----------------------
	$("#plus_jd1").click(function(){ $("#karta_jd1, #skill_value_jd1").html(jd[0] = add_point(jd[0],jd[1],jd[2],jd[3],jd[4])); });
	$("#minus_jd1").click(function(){ $("#karta_jd1, #skill_value_jd1").html(jd[0] = substract_point(jd[0],jd[1],jd[2],jd[3],jd[4])); });
	$("#plus_jd2").click(function(){ $("#karta_jd2, #skill_value_jd2").html(jd[1] = add_point(jd[1],jd[0],jd[2],jd[3],jd[4])); });
	$("#minus_jd2").click(function(){ $("#karta_jd2, #skill_value_jd2").html(jd[1] = substract_point(jd[1],jd[0],jd[2],jd[3],jd[4])); });
	$("#plus_jd3").click(function(){ $("#karta_jd3, #skill_value_jd3").html(jd[2] = add_point(jd[2],jd[0],jd[1],jd[3],jd[4])); });
	$("#minus_jd3").click(function(){ $("#karta_jd3, #skill_value_jd3").html(jd[2] = substract_point(jd[2],jd[0],jd[1],jd[3],jd[4])); });
	
	// SZTUCZKI --------------------------------------------------------------------------------------
	function show_sztuczki() { // function shows all avaliable sztuczki for picking at given moment
		$(".sztuczki_exmpl").hide();
		if (te[0] > 2 && pt[2] > 2) { $("#s_bum").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 13 && ww[1] > 4) { $("#s_aramis").show(); };
		if (sn[1] > 1) { $("#s_asekuracja").show(); };
		if (me[1] > 3 && em[1] > 2) { $("#s_aspiryna").show(); };
		if (ww[0] > 4 && bohater.budowa+bohater.d_bd > 13) { $("#s_barbarka").show(); };
		if (sw[0] > 5 && bohater.budowa+bohater.d_bd > 11) { $("#s_berserker").show(); };
		if (sn[0] > 3) { $("#s_bezoddechu").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 9 && sn[1] > 5) { $("#s_bezsprzetu").show(); };
		if (bs[0] > 2 && bohater.zrecznosc+bohater.d_zr > 12 &&bohater.percepcja+bohater.d_pc > 11) { $("#s_bezsznurków").show(); };
		if (sn[2] > 2 && bohater.budowa+bohater.d_bd > 11) { $("#s_bieg").show(); };
		if (bohater.charakter+bohater.d_ch > 7 && em[2] > 3) { $("#s_bierzgo").show(); };
		if (ww[1] > 4 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_boa").show(); };
		if (em[1] > 1 && ng[0] > 1 && zm[1] > 1 && bohater.spryt+bohater.d_sp > 9 ) { $("#s_casanova").show(); };
		if (bohater.spryt+bohater.d_sp > 13) { $("#s_chlodnymokiem").show(); };
		if (ka[0] > 5) { $("#s_ciszej").show(); };
		if (bohater.percepcja+bohater.d_pc > 7 && sw[2] > 2) { $("#s_czlowiek").show(); };
		if ((sp[0] > 2 || sp[1] > 2) && em[2] > 1) { $("#s_czterejpancerni").show(); };
		if (bohater.percepcja+bohater.d_pc > 13 && bs[2] > 3) { $("#s_czuly").show(); };
		if (bohater.budowa+bohater.d_bd > 11 && bd[1] > 8) { $("#s_dalszy").show(); };
		if (bd[2] > 3) { $("#s_dawid").show(); };
		if (bd[0] > 8 && bohater.budowa+bohater.d_bd > 11) { $("#s_dluzszystrzal").show(); };
		if (bohater.spryt+bohater.d_sp > 11) { $("#s_dobryizlyglina").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && (bs[0] > 4 || ww[1] > 4)) { $("#s_dobywanie").show(); };
		if (bohater.budowa+bohater.d_bd > 12 && sn[2] > 3) { $("#s_domnaplecach").show(); };
		if (bohater.budowa+bohater.d_bd > 11 && sn[2] > 4) { $("#s_doswiadczony").show(); };
		if (bohater.budowa+bohater.d_bd > 9 && ww[2] > 5) { $("#s_dystans").show(); };
		if (sn[2] > 2) { $("#s_dziswszystko").show(); };
		if (sn[2] > 2 && ww[0] > 3) { $("#s_flash").show(); };
		if (ww[0] > 3 && bohater.budowa+bohater.d_bd > 11) { $("#s_garda").show(); };
		if (bohater.budowa+bohater.d_bd > 11 && ot[2] > 2) { $("#s_glaz").show(); };
		if (zm[1] > 3) { $("#s_golareka").show(); };
		if (bohater.spryt+bohater.d_sp > 9 && ng[0] > 8) { $("#s_granienanerwach").show(); };
		if (bs[0] > 3 && bohater.zrecznosc+bohater.d_zr > 13) { $("#s_gunfight").show(); };
		if (zm[1] > 3) { $("#s_hokuspokus").show(); };
		if (me[1] > 3 && bohater.budowa+bohater.d_bd > 11) { $("#s_immunitet").show(); };
		if (ng[2] > 2) { $("#s_inspiracja").show(); };
		if (em[1] > 5 && bohater.charakter+bohater.d_ch > 15) { $("#s_jestzajebiscie").show(); };
		if (bohater.spryt+bohater.d_sp > 11 && ot[0] > 3) { $("#s_kanaly").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 13 && sg[2] > 2) { $("#s_komandos").show(); };
		if (ww[0] > 3 && bohater.zrecznosc+bohater.d_zr > 13 && bohater.budowa+bohater.d_bd > 7) { $("#s_kopzobrotu").show(); };
		if (sn[1] > 3 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_kot").show(); };
		if (zm[0] > 1 && ka[1] > 1) { $("#s_kradziezwtlumie").show(); };
		if (ka[1] > 4 && pr[0] > 1) { $("#s_lesnydiabel").show(); };
		if (bd[1] > 5) { $("#s_ladowaniekuszy").show(); };
		if (bohater.budowa+bohater.d_bd > 13) { $("#s_lawnik").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && (bs[0] > 2 || bs[1] > 2)) { $("#s_magazynek").show(); };
		if (sp[0] > 3 && bohater.spryt+bohater.d_sp > 11) { $("#s_meczbojowy").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && bohater.percepcja+bohater.d_pc > 9 && ww[2] > 1 && ot[0] > 0) { $("#s_miotaczkul").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && em[1] > 2 && me[2] > 2) { $("#s_mistrzopaskiuciskowej").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 13 && ww[1] > 5) { $("#s_mistrzwloczni").show(); };
		if (em[0] > 10 && (te[0] > 10 || te[1] > 10)) { $("#s_myslecjakmaszyna").show(); };
		if (pt[0] > 3) { $("#s_napewnodzialal").show(); };
		if (bohater.spryt+bohater.d_sp > 12 && te[0] > 2) { $("#s_naprawde").show(); };
		if (wo[0] > 3 || wo[1] > 3 || wo[2] > 3) { $("#s_nauczyciel").show(); };
		if (bohater.charakter+bohater.d_ch > 11 && sw[0] > 3) { $("#s_niewrazliwosc").show(); };
		if (pt[0] > 3) { $("#s_nostrzelaj").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && ww[1] > 4) { $("#s_nozownik").show(); };
		if (ww[0] > 1) { $("#s_obezwladnienie").show(); };
		if (bohater.spryt+bohater.d_sp > 11 && bohater.charakter+bohater.d_ch > 11) { $("#s_odnajdowanie").show(); };
		if (pr[2] > 3) { $("#s_odpornosc").show(); };
		if (pr[1] > 5) { $("#s_odtrucie").show(); };
		if (bohater.spryt+bohater.d_sp > 9 && zm[0] > 3) { $("#s_odwrocenie").show(); };
		if (ww[0] > 4 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_origami").show(); };
		if ((ww[0] > 3 || ww[1] > 3) && sn[2] > 1 && bohater.spryt+bohater.d_sp > 11) { $("#s_osmiornica").show(); };
		if (te[1] > 1 && zm[2] > 1) { $("#s_otwieraniezamkowelektronicznych").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && bohater.budowa+bohater.d_bd > 11) { $("#s_padnij").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 13 && sn[1] > 7) { $("#s_pajak").show(); };
		if (me[2] > 3 && bohater.spryt+bohater.d_sp > 13) { $("#s_panplaster").show(); };
		if ((bs[0] > 2 || bs[1] > 2) && bohater.zrecznosc+bohater.d_zr > 11 && bohater.charakter+bohater.d_ch > 11) { $("#s_pewnareka").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 11 && ww[0] > 2 && sn[2] > 1) { $("#s_pierwotny").show(); };
		if (sn[2] > 2 && bohater.zrecznosc+bohater.d_zr > 12 && bohater.percepcja+bohater.d_pc > 11) { $("#s_pitbull").show(); };
		if (te[2] > 1 && (sp[0] > 1 || sp[1] > 1)) { $("#s_plugplay").show(); };
		if (pp[2] > 2 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_poschodach").show(); };
		if (bohater.spryt+bohater.d_sp > 11 && (te[0] > 5 || te[1] > 5)) { $("#s_podrasowanie").show(); };
		if (pp[2] > 5 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_polozeniemotocykla").show(); };
		if (te[0] > 2 || te[1] > 2) { $("#s_prowizorka").show(); };
		if (sn[1] > 2) { $("#s_rappeling").show(); };
		if (jd[0] > 2 && jd[2] > 4) { $("#s_rodeo").show(); };
		if (ww[0] > 5 && bohater.zrecznosc+bohater.d_zr > 11 && bohater.budowa+bohater.d_bd > 11) { $("#s_rozroba").show(); };
		if (ww[0] > 2 && bohater.charakter+bohater.d_ch > 15) { $("#s_roar").show(); };
		if (bohater.budowa+bohater.d_bd > 15 && bs[2] > 5) { $("#s_ruchomegniazdo").show(); };
		if ((bs[0] > 3 || bs[1] > 3 || bs[2] > 3) && bohater.spryt+bohater.d_sp > 11 && bohater.percepcja+bohater.d_pc > 9) { $("#s_ruchomycel").show(); };
		if ((te[0] > 3 || te[1] > 3) && bohater.spryt+bohater.d_sp > 9) { $("#s_rzutoka").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 9 && ww[1] > 2) { $("#s_samuraj").show(); };
		if (ot[1] > 5) { $("#s_sherlock").show(); };
		if (bohater.budowa+bohater.d_bd > 12 && ww[2] > 3) { $("#s_sleklerezada").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 13 && ww[0] > 3) { $("#s_slup").show(); };
		if (bohater.percepcja+bohater.d_pc > 9 && bd[2] > 1) { $("#s_skladamunicji").show(); };
		if (bohater.charakter+bohater.d_ch > 13 && pp[2] > 3) { $("#s_skok").show(); };
		if (sg[0] > 3) { $("#s_sluchabsolutny").show(); };
		if (bs[1] > 5 && bohater.percepcja+bohater.d_pc > 13) { $("#s_snajper").show(); };
		if (sn[0] > 4) { $("#s_spacnawodzie").show(); };
		if (bs[0] > 1 && bohater.percepcja+bohater.d_pc > 9 && bohater.spryt+bohater.d_sp > 9) { $("#s_strzeleckieszonkowy").show(); };
		if (ww[0] > 3 || ww[1] > 3) { $("#s_szachista").show(); };
		if (sg[2] > 6 && bohater.percepcja+bohater.d_pc > 13) { $("#s_szostyzmysl").show(); };
		if (zm[1] > 7 && bohater.spryt+bohater.d_sp > 11) { $("#s_sztuczkikarciane").show(); };
		if (pt[0] > 1) { $("#s_sztuka").show(); };
		if (bohater.zrecznosc+bohater.d_zr > 13) { $("#s_szybkibill").show(); };
		if (ww[2] > 3 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_szybkirzut").show(); };
		if (bd[0] > 3 && bohater.budowa+bohater.d_bd > 11) { $("#s_szybkiestrzelanie").show(); };
		if (bs[1] > 3) { $("#s_srubobranie").show(); };
		if (ww[1] > 3 && bohater.budowa+bohater.d_bd > 13) { $("#s_taran").show(); };
		if (pp[0] > 2 || pp[1] > 2) { $("#s_taranowanie").show(); };
		if (sw[1] > 6 && ng[0] > 3) { $("#s_targowaniesie").show(); };
		if (ng[2] > 2) { $("#s_tosierobitak").show(); };
		if (bohater.percepcja+bohater.d_pc > 11 && sg[1] > 3) { $("#s_wmgnieniuoka").show(); };
		if (ww[1] > 4 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_walkadwiemabronmi").show(); };
		if (ww[0] > 1 && bohater.charakter+bohater.d_ch > 11) { $("#s_wiatraki").show(); };
		if (true) { $("#s_wilkmorski").show(); };
		if (em[1] > 2 && bohater.percepcja+bohater.d_pc > 9 && bohater.charakter+bohater.d_ch > 9) { $("#s_wlasciwatwarz").show(); };
		if (ww[2] > 3 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_wracajacybumerang").show(); };
		if ((ww[0] > 5 || ww[1] > 5) && bohater.percepcja+bohater.d_pc > 11) { $("#s_wyczekanie").show(); };
		if (em[0] > 1 && em[2] > 1) { $("#s_wyczucieemocjizwierzat").show(); };
		if (sg[2] > 3 && bohater.spryt+bohater.d_sp > 11) { $("#s_wyczuciepromieniowania").show(); };
		if (pr[2] > 1 && bohater.percepcja+bohater.d_pc > 11) { $("#s_wyczuciezmianpogody").show(); };
		if ((bd[0] > 1 || bd[1] > 1) && bohater.spryt+bohater.d_sp > 9) { $("#s_wyrabianiestrzalibeltow").show(); };
		if (zm[2] > 3 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_wytrych").show(); };
		if (bohater.spryt+bohater.d_sp > 11 && em[1] > 1 && zm[1] > 1) { $("#s_zagadanie").show(); };
		if (ww[0] > 1 && bohater.budowa+bohater.d_bd > 11) { $("#s_zaslona").show(); };
		if (ww[2] > 1 && bohater.zrecznosc+bohater.d_zr > 11) { $("#s_zgranie").show(); };
		if (bs[0] > 2 && bohater.percepcja+bohater.d_pc > 13 && bohater.spryt+bohater.d_sp > 9 && bohater.zrecznosc+bohater.d_zr > 9) { $("#s_zielonybalonik").show(); };
		if (ng[1] > 3 && bohater.charakter+bohater.d_ch > 11) { $("#s_zly").show(); };
		if ((ww[0] > 4 || ww[1] > 4) && bohater.spryt+bohater.d_sp > 11) { $("#s_zmylka").show(); };
